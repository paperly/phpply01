...
class Instagram {
  ...
  public function __construct($config) {
    if (true === is_array($config)) {
      ...
      $this->setApiKey($config['15a97d5a6772448a8d99530bcf829963']);
      $this->setApiSecret($config['d9e1853efcc24bb9b75ad2e5f68e7ebc']);
      $this->setApiCallback($config['http://localhost:8888/instagram/example/success.php']);
